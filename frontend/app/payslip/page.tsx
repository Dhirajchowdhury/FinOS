  ...
  return (
    ...
    >
      <div className="space-y-6 max-w-5xl mx-auto">
        ...
        {/* STEP 1: UPLOAD AREA */}
        {step === 1 && (
          <div className="bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 sm:p-10 shadow-xs space-y-6">
        ...
        {(step === 2 || step === 3 || step === 4) && (
          <div className="bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 rounded-2xl p-10 text-center space-y-6 shadow-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 shadow-xs">
                ...
                <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400 font-mono mt-1">
                  {formatINR(analysisResult.incomeSummary.netSalary)}
                </div>
              ...
              <div className="p-4 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 shadow-xs">
                ...
                <div className="text-2xl font-black text-slate-900 dark:text-white font-mono mt-1">
                  {formatINR(analysisResult.incomeSummary.taxDeduction)}
                </div>
              ...
              <div className="p-4 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 shadow-xs">
                ...
                <div className="text-2xl font-black text-slate-900 dark:text-white font-mono mt-1">
                  {formatINR(analysisResult.incomeSummary.otherDeductions)}
                </div>
              ...
              <div className="p-5 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-3">
                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-800 text-xs">
                  {analysisResult.breakdown.earnings.map((e) => (
                    <div key={e.item} className="py-2.5 flex items-center justify-between">
              ...
              <div className="p-5 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-3">
                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-800 text-xs">
                  {analysisResult.breakdown.deductions.map((d) => (
                    <div key={d.item} className="py-2.5 flex items-center justify-between">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                {analysisResult.insights.map((ins, idx) => (
                  <div
                    key={idx}
                    className="p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-900/60 space-y-2"
                  >
        ...
        {generatedReportOpen && analysisResult && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs animate-in fade-in">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-2xl w-full p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
              <button
