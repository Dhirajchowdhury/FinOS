    ...
    <div className="bg-white dark:bg-[#0c1222] border border-slate-200/90 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xs flex flex-col justify-between">
      <div>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-500 border border-slate-200 dark:border-slate-700 flex items-center gap-1">
            <span>Offline</span>
          </span>
        </div>
        ...
        {displayIndices.length === 0 ? (
          <div className="py-6 text-center text-xs text-slate-500 font-mono">
            Market data unavailable. Exchange ticker feed is offline.
          </div>
        ) : (
